r_df_6 <- r_df
r_df_6[] <- lapply(r_df, as.character)
...
for(i in 2:120){
  ...
  mean(df_arranged_top_f$abc) -> t_means[i]
  ######
  ...
  mean(df_arranged_bot_f$abc) -> b_means[i]
